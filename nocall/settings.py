"""
Django settings for nocall project.
...
SECRET_KEY = 'cbq)#mp$@6^jsoeu-!7n(ll3md!nkdynggg3s+be)h4+zasn&s'
...
WSGI_APPLICATION = 'nocall.wsgi.application'
